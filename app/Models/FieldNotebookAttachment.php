...
/**
 * @property int $fieldNotebookAttachmentId
 ...
 */
class FieldNotebookAttachment extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'fieldnotebookattachment';
     ...
     * @var string
     */
    protected $primaryKey = 'FieldNotebookAttachmentId';
