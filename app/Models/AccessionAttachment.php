...
/**
 * @property int $accessionAttachmentID
 ...
 */
class AccessionAttachment extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'accessionattachment';
     ...
     * @var string
     */
    protected $primaryKey = 'AccessionAttachmentID';
