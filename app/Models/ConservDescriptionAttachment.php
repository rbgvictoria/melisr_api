...
/**
 * @property int $conservDescriptionAttachmentID
 ...
 */
class ConservDescriptionAttachment extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'conservdescriptionattachment';
     ...
     * @var string
     */
    protected $primaryKey = 'ConservDescriptionAttachmentID';
