...
/**
 * @property int $collectingTripAuthorizationID
 ...
 */
class CollectingTripAuthorization extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'collectingtripauthorization';
     ...
     * @var string
     */
    protected $primaryKey = 'CollectingTripAuthorizationID';
