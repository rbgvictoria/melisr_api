...
/**
 * @property int $preparationPropertyID
 ...
 */
class PreparationProperty extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'preparationproperty';
     ...
     * @var string
     */
    protected $primaryKey = 'PreparationPropertyID';
