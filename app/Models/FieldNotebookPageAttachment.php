...
/**
 * @property int $fieldNotebookPageAttachmentId
 ...
 */
class FieldNotebookPageAttachment extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'fieldnotebookpageattachment';
     ...
     * @var string
     */
    protected $primaryKey = 'FieldNotebookPageAttachmentId';
