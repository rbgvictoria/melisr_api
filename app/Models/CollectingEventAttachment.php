...
/**
 * @property int $collectingEventAttachmentID
 ...
 */
class CollectingEventAttachment extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'collectingeventattachment';
     ...
     * @var string
     */
    protected $primaryKey = 'CollectingEventAttachmentID';
