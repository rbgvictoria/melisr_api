...
/**
 * @property int $localityAttachmentID
 ...
 */
class LocalityAttachment extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'localityattachment';
     ...
     * @var string
     */
    protected $primaryKey = 'LocalityAttachmentID';
