...
/**
 * @property int $exchangeInAttachmentID
 ...
 */
class ExchangeInAttachment extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'exchangeinattachment';
     ...
     * @var string
     */
    protected $primaryKey = 'ExchangeInAttachmentID';
