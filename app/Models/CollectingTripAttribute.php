 ...
 */
class CollectingTripAttribute extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'collectingtripattribute';
     ...
     * @var string
     */
    protected $primaryKey = 'CollectingTripAttributeID';
     ...
     */
    public function collectingTrip(): HasOne
    {
        return $this->hasOne(CollectingTrip::class, 'CollectingTripAttributeID', 'CollectingTripAttributeID');
    }
